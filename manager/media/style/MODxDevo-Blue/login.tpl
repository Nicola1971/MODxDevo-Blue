...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#499bea', endColorstr='#207ce5',GradientType=0 ););
   ...
   .sectionHeader a,.sectionHeader a:active,.sectionHeader a:visited,.sectionHeader a:link {color: #FFF;text-decoration: none; text-shadow: 1px 1px 1px #330000;}
    .sectionBody {padding: 2px 20px 20px;display: block;background: #f9f9f9;
	    height: auto !important;
    height: 270px;
    min-height: 270px;
}
    #mx_loginbox {width: 460px;margin: 30px auto 0; border: 1px solid #ccc;-webkit-border-radius: 6px;
...
box-shadow: 0px 2px 5px #666666; }
	...
	input.login:hover {
		background: #82bd42;
	background: -moz-linear-gradient(top, #82bd42 0%, #9bc747 100%);
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#82bd42), color-stop(100%,#9bc747));
	background: -webkit-linear-gradient(top, #82bd42 0%,#9bc747 100%);
	background: -o-linear-gradient(top, #82bd42 0%,#9bc747 100%);
	background: -ms-linear-gradient(top, #82bd42 0%,#9bc747 100%);
	background: linear-gradient(to bottom, #82bd42 0%,#9bc747 100%);
